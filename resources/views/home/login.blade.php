...
<div class="row">
    <div class="col-12 text-center">
        ...
        <a class="btn btn-primary w-50 py-2" href="{{ route('dashboard') }}">AUTHORIZATION</a>
...
<div class="row">
    ...
    <div class="col-md-8 col-sm-12">
        <input class="form-control mb-3 text-center py-2" type="text" placeholder="Enter TRX Address or ID">
        <input class="btn btn-primary mb-2 w-100 py-2" type="button" value="VIEWING">
    </div>
</div>
